...
#include <stdbool.h>        // Incluir biblioteca para el tipo de datos bool
#include "../tdas/list.h"   // Incluir la interfaz para la lista
#include "../tdas/hash.h"   // Incluir la interfaz para el mapa hash
